...
export function createCanonicalRuntimeManifest(
  ...
  if (!activity.id.trim() || !activity.source) {
    throw new CanonicalRuntimeAdapterError(
      "A canonical runtime activity requires an id and source.",
    );
  }
  ...
  switch (activity.runtime) {
    ...
    case "html-css":
      if (!activity.fixture) {
        throw new CanonicalRuntimeAdapterError(
          "The html-css runtime requires an explicit HTML fixture.",
        );
      }
      return {
        kind: "html-css",
    ...
    case "html-javascript":
      if (!activity.fixture) {
        throw new CanonicalRuntimeAdapterError(
          "The html-javascript runtime requires an explicit HTML fixture.",
        );
      }
      return {
        kind: "html-javascript",
